# Optimized CyGNet paper package

This folder is based on the uploaded optimized CyGNet code and adds reviewer-safe HVA/RHVC scripts aligned with the paper. See `README_HVA_CYGNET.md` and `docs/CYGNET_HVA_PROTOCOL.md` first.
